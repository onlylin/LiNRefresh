#
#  Be sure to run `pod spec lint LNRefresh.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "LiNRefreshExample/LiNRefresh/*.swift"
